...
})({"2asff":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6f9556fee5cb7c35";
"use strict";
...
},{}],"he9if":[function(require,module,exports,__globalThis) {
var _sortAndFilterJs = require("./sortAndFilter.js");
var _categoriesJs = require("./categories.js");
var _modalJs = require("./modal.js");
var _utilsJs = require("./utils.js");
var _bootstrap = require("bootstrap");
let products = [];
(0, _sortAndFilterJs.initialize)().then((fetchedProducts)=>{
    products = fetchedProducts;
});
(0, _categoriesJs.fetchCategories)();
document.getElementById("minPrice").addEventListener("input", (0, _sortAndFilterJs.applyFiltersAndSort));
document.getElementById("maxPrice").addEventListener("input", (0, _sortAndFilterJs.applyFiltersAndSort));
const sortButtons = document.querySelectorAll("#priceAsc, #priceDesc, #ratingsAsc, #ratingsDesc");
sortButtons.forEach((button)=>{
    button.addEventListener("click", (event)=>{
        (0, _sortAndFilterJs.setSortCriteria)(event.target.id);
    });
});
document.querySelectorAll('.product-card').forEach((card)=>{
    card.addEventListener('click', ()=>{
        const productId = card.getAttribute('data-product-id');
        const product = (0, _utilsJs.getProductById)(productId, products);
        if (product) {
            const modal = (0, _modalJs.createModal)(product);
            document.body.appendChild(modal);
            const bootstrapModal = new _bootstrap.Modal(modal, {
                backdrop: 'static',
                keyboard: false
            });
            bootstrapModal.show();
...
},{"./sortAndFilter.js":"brXpz","./categories.js":"fQSNJ","./modal.js":"a4OwA","./utils.js":"aqGVv","bootstrap":"h36JB"}],"brXpz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initialize", ()=>initialize);
parcelHelpers.export(exports, "applyFiltersAndSort", ()=>applyFiltersAndSort);
parcelHelpers.export(exports, "setSortCriteria", ()=>setSortCriteria);
var _fetchJs = require("./fetch.js");
var _createCardJs = require("./createCard.js");
let products = [];
let sortCriteria = "";
async function initialize() {
    const products = await (0, _fetchJs.getData)();
    renderProducts(products);
    return products;
}
const filterByCategory = (categories)=>(product)=>categories.length === 0 || categories.includes(product.getCategory);
const filterByPrice = (minPrice, maxPrice)=>(product)=>product.getPrice >= minPrice && product.getPrice <= maxPrice;
...
function applyFiltersAndSort() {
    ...
    const filteredProducts = products.filter(filterByCategory(selectedCategories)).filter(filterByPrice(minPrice, maxPrice)).sort(sortProducts(sortCriteria));
...
function renderProducts(products) {
    ...
    products.forEach((product)=>{
        const card = (0, _createCardJs.createCard)(product);
        container.appendChild(card);
    });
}

},{"./fetch.js":"4S4J2","./createCard.js":"i3CSg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4S4J2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function getData() {
    ...
    try {
        ...
        console.log(json);
        return json.products.map((product)=>new (0, _productJs.Product)(product.id, product.title, product.thumbnail, product.images, product.stock, product.price, product.discountPercentage, product.category, product.rating));
    } catch (error) {
...
},{"./product.js":"3L06P","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3L06P":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"i3CSg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./modal.js":"a4OwA","bootstrap":"h36JB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a4OwA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createModal(product) {
  ...
  `;
    ...
    lowerAmount.addEventListener("click", (event)=>{
        event.preventDefault();
        event.stopPropagation();
        if (parseInt(amountInput.value) > 0) amountInput.value = (parseInt(amountInput.value) - 1).toString();
    });
    higherAmount.addEventListener("click", (event)=>{
        event.preventDefault();
        event.stopPropagation();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h36JB":[function(require,module,exports,__globalThis) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fQSNJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function fetchCategories() {
    try {
        const data = await (0, _fetchJs.getData)();
        const categories = [
            ...new Set(data.map((product)=>product.getCategory))
        ];
...
function renderCategories(categories) {
    ...
    categories.forEach((category)=>{
        ...
        input.addEventListener("change", (0, _sortAndFilterJs.applyFiltersAndSort));
...
},{"./fetch.js":"4S4J2","./sortAndFilter.js":"brXpz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aqGVv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2asff","he9if"], "he9if", "parcelRequire94c2")

//# sourceMappingURL=index.e5cb7c35.js.map
